...
namespace logic.util
{
	...
	//Derived from Ken Perlin algorith.
	//https://mrl.nyu.edu/~perlin/ghost/INoise.java
	public static class LogicPerlinNoise
	{
		...
		{
			int t0 = f[t >> 8], t1 = f[Min(255, (t >> 8) + 1)];
		...
		//Permutations x2 so we do not need to check overflows.
